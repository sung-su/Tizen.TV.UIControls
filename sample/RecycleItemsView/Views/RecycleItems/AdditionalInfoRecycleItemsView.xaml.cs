...
{
    public partial class AdditionalInfoRecycleItemsView : Tizen.TV.UIControls.Forms.RecycleItemsView
    {
        public AdditionalInfoRecycleItemsView()
        {
            InitializeComponent();
        }
        ...
        protected override void OnItemFocused(object data, View targetView, bool isFocused)
        {
            try
            {
                ...
                Frame info = layout.FindByName<Frame>("InfoLayout");
                if (info == null)
                {
                    return;
                }
