...
namespace Tizen.TV.UIControls.Forms
{
    ...
    public class GridView : View, IGridViewController
    {
        ...
        /// </summary>
        public static readonly BindableProperty ItemHorizontalAlignmentProperty = BindableProperty.Create("ItemHorizontalAlignment", typeof(double), typeof(GridView), 0.5);

        /// <summary>
        /// Identifies the ItemVerticalAlignment bindable property.
        /// </summary>
        public static readonly BindableProperty ItemVerticalAlignmentProperty = BindableProperty.Create("ItemVerticalAlignment", typeof(double), typeof(GridView), 0.5);
